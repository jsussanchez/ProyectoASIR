...
<head>
	<meta charset="UTF-8"/>
	<title>BurgerCity: Password perdido</title>	
	...
	<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="container registrousuarios">
			...
			<div class="col-sm-9 registroh3">
				<h3 class="navbar-right">PASSWORD PERDIDO</h3>
			</div>
		</div>
	</nav>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					<h3><i>Por favor, introduce tu dirección de email para resetear tu password</i></h3>
				</div>
			</div>
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
